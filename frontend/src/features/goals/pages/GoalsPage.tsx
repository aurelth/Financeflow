    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          >
            Defina objetivos e regista contribuições através das tuas transações
          </p>
        </div>
        <button
            ...
            >
              ...
              <div className="text-center">
                ...
                <p
                  ...
                  style={{ color: "var(--ff-text-muted)" }}
                >
                  Cria a tua primeira meta financeira e começa a acompanhar o
