  ...
  return (
    <div className="flex items-center gap-1.5">
      {met ? (
        <Check
          size={11}
          style={{ color: "var(--ff-emerald)", flexShrink: 0 }}
        />
      ) : (
        <X size={11} style={{ color: "var(--ff-text-muted)", flexShrink: 0 }} />
      )}
      <span
        style={{
          fontSize: "11px",
          color: met ? "var(--ff-emerald)" : "var(--ff-text-muted)",
...
export default function RegisterPage() {
  ...
  const requirements = [
    { met: passwordValue.length >= 8, label: "Mínimo 8 caracteres" },
    { met: /[A-Z]/.test(passwordValue), label: "Uma letra maiúscula" },
    { met: /[0-9]/.test(passwordValue), label: "Um número" },
    { met: /[^a-zA-Z0-9]/.test(passwordValue), label: "Um símbolo (!@#$...)" },
  ];
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1.5">
            ...
            <input
              ...
              style={inputStyle}
              onFocus={(e) =>
                (e.target.style.borderColor = "var(--ff-emerald)")
              }
              onBlur={(e) => (e.target.style.borderColor = "var(--ff-border)")}
            />
            {errors.cpf && (
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <option value="Male" style={{ background: "#111" }}>
                {t("register.genderMale")}
              </option>
              <option value="Female" style={{ background: "#111" }}>
